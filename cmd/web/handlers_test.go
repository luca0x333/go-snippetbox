...
func TestPing(t *testing.T) {
	// Create a new instance of the application struct which uses mocked dependencies.
...
func TestSignupUser(t *testing.T) {
	...
	// Make a GET request to /user/signup and extract the CSRF token from the response body.
